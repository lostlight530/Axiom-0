...
> **[EN]:** The world is high-entropy, but the system must be absolute zero-entropy. The core mission of the post-processing mechanism is to forcefully drain all uncertainty and chaotic moisture from the information torrent before it hits the core defense line. Any redundant polite phrasing, vague guesses, and leaps of human thought must be crushed into the most basic structured assertions during this phase.
