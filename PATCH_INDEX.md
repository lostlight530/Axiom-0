...
- **[CN]**: `ADR/ADR-062-神话一代-lane.md`
  - **[EN]**: `ADR/ADR-062-mythic-generation-lane.md`
- **[CN]**: `ADR/ADR-063-人类-ai-后处理-边界.md`
  - **[EN]**: `ADR/ADR-063-human-ai-postprocessing-boundary.md`
- **[CN]**: `ADR/ADR-066-research-to-adr-distillation.md`
  - **[EN]**: `ADR/ADR-066-research-to-adr-distillation.md`
- **[CN]**: `ADR/ADR-067-证据-状态-标签.md`
  - **[EN]**: `ADR/ADR-067-evidence-status-labeling.md`
- **[CN]**: `ADR/ADR-068-index-synchronization-and-nav-contract.md`
  - **[EN]**: `ADR/ADR-068-index-synchronization-and-nav-contract.md`
- **[CN]**: `ADR/ADR-069-repo-knowledge-stratification.md`
